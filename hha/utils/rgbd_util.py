...
def process_depth_image(z, missing_mask, C):
    ...
    N1, b1 = computeNormalsSquareSupport(z / 100, missing_mask, normalParam_patchSize[0],
                                         1, C, np.ones(z.shape))
    N2, b2 = computeNormalsSquareSupport(z / 100, missing_mask, normalParam_patchSize[1],
                                         1, C, np.ones(z.shape))
